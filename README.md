...
#### Boot from Docker
Run `docker run -p 1935:19035 -p 7001:19080 -p 7002:7002 -p 8090:8090 -d gwuhaolin/livego` to start
...
3. Upstream push: Push the video stream to `rtmp://localhost:19035/{appname}/{channelkey}` through the` RTMP` protocol(default appname is `live`), for example, use `ffmpeg -re -i demo.flv -c copy -f flv rtmp://localhost:19035/{appname}/{channelkey}` push([download demo flv](https://s3plus.meituan.net/v1/mss_7e425c4d9dcb4bb4918bbfa2779e6de1/mpack/default/demo.flv));
...
Usage of ./livego:
      ...
      --httpflv_addr string   HTTP-FLV server listen address (default ":19080")
